    ...
    <div class="card-body">
        <div class="table-responsive">
            ...
            <div>
                ...
                <a href="https://growcrm.io/documentation"  target="_blank" class="btn btn-sm btn-info help-documentation"><i class="ti-info-alt"></i> <?php echo e(cleanLang(__('lang.help_documentation'))); ?></a>
            </div>
        </div>
    </div>
</div><?php /**PATH /app/application/resources/views/pages/categories/components/table/table.blade.php ENDPATH**/ ?>