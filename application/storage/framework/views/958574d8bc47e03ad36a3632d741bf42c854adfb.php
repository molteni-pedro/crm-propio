...
<!--section js resource-->
<span class="hidden" id="js-settings-logos-modal" data-size="<?php echo e(request('logo_size')); ?>">placeholder</span><?php /**PATH /app/application/resources/views/pages/settings/sections/logos/modals/update-logo.blade.php ENDPATH**/ ?>