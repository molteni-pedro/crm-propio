    ...
    <table id="demo-taxrate-addrow" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10">
        <thead>
            <tr>
                ...
                <th class="taxrates_col_action w-px-100"><a href="javascript:void(0)"><?php echo e(cleanLang(__('lang.action'))); ?></a></th>
            </tr>
        </thead>
...
</div><?php /**PATH /app/application/resources/views/pages/settings/sections/taxrates/table/table.blade.php ENDPATH**/ ?>